...
export default function BackButton() {
  ...
  return (
    ...
    >
      <span className="inline-flex items-center justify-center w-8 h-8 rounded-lg border border-foreground/10 bg-foreground/1 group-hover:bg-foreground/2 group-hover:-translate-x-1 transition-all duration-300">
